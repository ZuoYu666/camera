...
Namespace MVAPI
    ...
    Class MVGigE
        ...
        '<returns>	MVST_SUCCESS	: 成功</returns>
        <DllImport("MVGigE.dll")>
        Public Shared Function MVGetCameraInfo(ByRef idx As Byte, ByRef pCamInfo As MVCamInfo) As MVSTATUS_CODES
        End Function
    ...
    Class MVImage
        ...
        <DllImport("MVGigE.dll")>
        Public Shared Function MVImageDraw(ByVal hImage As IntPtr, ByRef hDestDC As IntPtr, ByVal xDest As Integer, ByVal yDest As Integer) As Boolean
        End Function
        ...
        <DllImport("MVGigE.dll")>
        Public Shared Function MVImageDrawEx(ByVal hImage As IntPtr, ByVal hDestDC As IntPtr, ByVal xDest As Integer, ByVal yDest As Integer, ByVal nDestWidth As Integer, ByVal nDestHeight As Integer, ByVal xSrc As Integer, ByVal ySrc As Integer, ByVal nSrcWidth As Integer, ByVal nSrcHeight As Integer) As Boolean
        End Function
        ...
        '  \param [in]  yDest   图像绘制的起始垂直坐标
        <DllImport("MVGigE.dll")>
        Public Shared Function MVImageDrawHwnd(ByVal hImage As IntPtr, ByVal HWND As IntPtr, ByVal xDest As Integer, ByVal yDest As Integer) As Boolean
        End Function

        <DllImport("MVGigE.dll")>
        Public Shared Function MVImageDrawHwndEx(ByVal hImage As IntPtr, ByVal HWND As IntPtr, ByVal xDest As Integer, ByVal yDest As Integer) As Boolean
        End Function
    ...
    Class MVSequenceDlg
        ...
        <DllImport("MVTickDlg")>
        Public Shared Function MVSequenceDlgCreateEx(ByRef phSeqDlg As IntPtr, ByVal pParentWnd As IntPtr) As Boolean
        End Function
        ...
        '  \retval
        <DllImport("MVTickDlg")>
        Public Shared Function MVSequenceDlgDestroy(ByVal hSeqDlg As IntPtr) As Boolean
        End Function
        ...
        '  \retval
        <DllImport("MVTickDlg")>
        Public Shared Function MVSequenceDlgShow(ByVal hSeqDlg As IntPtr, ByVal nCmdShow As MVShowWindowEnums) As Boolean
        End Function
        ...
        <DllImport("MVTickDlg")>
        Public Shared Function MVSequenceDlgGetFileName(ByVal hSeqDlg As IntPtr, ByVal fname As StringBuilder, ByVal szBuf As Int32) As Integer
        End Function
