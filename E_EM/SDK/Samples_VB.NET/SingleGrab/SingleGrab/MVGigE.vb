...
Namespace MVAPI
    ...
    Class MVGigE
        ...
        <DllImport("MVGigE.dll")>
        Public Shared Function MVSingleGrab(ByVal hCam As IntPtr, ByVal hImage As IntPtr, ByVal nWaitMs As Int32) As MVSTATUS_CODES
        End Function
        ...
        <DllImport("MVGigE.dll")>
        Public Shared Function MVImageFlip(ByVal hCam As IntPtr, ByRef pSrcImage As IntPtr, ByRef pDstImage As IntPtr, ByRef flipType As ImageFlipType) As MVSTATUS_CODES
        End Function
