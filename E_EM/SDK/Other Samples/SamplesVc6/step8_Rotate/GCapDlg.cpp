...
BEGIN_MESSAGE_MAP(CGCapDlg, CDialog)
	//{{AFX_MSG_MAP(CGCapDlg)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_OPEN, OnOpen)
	ON_BN_CLICKED(IDC_START, OnStart)
	ON_WM_DESTROY()
	ON_CBN_SELCHANGE(IDC_CMB_ZOOM, OnSelchangeZoom)
	ON_BN_CLICKED(IDC_SAVE, OnSave)
	ON_CBN_SELCHANGE(IDC_CMB_ROTATE, OnSelchangeRotate)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CGCapDlg::OnSelchangeRotate() 
{
