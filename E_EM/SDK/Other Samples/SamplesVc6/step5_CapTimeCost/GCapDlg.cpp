...
BEGIN_MESSAGE_MAP(CGCapDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_TRIG_CONTINUE, OnBnClickedTrigContinue)
	ON_EN_KILLFOCUS(IDC_EXPOSURE, OnEnKillfocusExposure)
	ON_EN_KILLFOCUS(IDC_WIDTH, OnEnKillfocusWidth)
	ON_EN_KILLFOCUS(IDC_HEIGHT, OnEnKillfocusHeight)
END_MESSAGE_MAP()
