...
Begin VB.Form Form1 
   ...
   Begin VB.CommandButton SetExp 
      ...
      Width           =   615
   End
   Begin VB.CommandButton SetGain 
      Caption         =   "设置"
      Enabled         =   0   'False
      Height          =   375
      Left            =   10080
    ...
    Else
        ...
        Else
            ...
            If hCam <> 0 Then
                ...
                rt = MVGetGain(hCam, fGain)
                rt = MVGetExposureTime(hCam, fExp)
                
                Form1.EditGain.Text = fGain
                Form1.EditExp.Text = fExp
...
Private Sub SetExp_Click()
    Dim fExp As Double
    fExp = Form1.EditExp.Text
    MVSetExposureTime hCam, fExp
End Sub

Private Sub SetGain_Click()
    Dim fGain As Double
    fGain = Form1.EditGain.Text
    MVSetGain hCam, fGain
End Sub
