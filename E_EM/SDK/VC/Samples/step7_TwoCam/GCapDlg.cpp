...
BEGIN_MESSAGE_MAP(CGCapDlg, CDialog)
	...
	ON_WM_SIZE()
	ON_BN_CLICKED(IDC_BUTTON1_GAIN, &CGCapDlg::OnBnClickedButton1Gain)
	ON_BN_CLICKED(IDC_BUTTON2_GAIN, &CGCapDlg::OnBnClickedButton2Gain)
	ON_BN_CLICKED(IDC_BUTTON1_EXPO, &CGCapDlg::OnBnClickedButton1Expo)
	ON_BN_CLICKED(IDC_BUTTON2_EXPO, &CGCapDlg::OnBnClickedButton2Expo)
	ON_CBN_SELCHANGE(IDC_COMBO_ZOOM, &CGCapDlg::OnCbnSelchangeComboZoom)
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN_GAIN1, &CGCapDlg::OnDeltaposSpinGain1)
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN_GAIN2, &CGCapDlg::OnDeltaposSpinGain2)
END_MESSAGE_MAP()
